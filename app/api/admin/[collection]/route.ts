import { NextRequest,NextResponse } from "next/server";import bcrypt from "bcryptjs";import { db } from "@/lib/db";import { User,Tab,Snippet,Tool } from "@/lib/models";import { sessionFromRequest } from "@/lib/auth";
const collections:any={users:User,tabs:Tab,snippets:Snippet,tools:Tool};
